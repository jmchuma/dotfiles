" Vim syntax file
" Copied from the java syntax file of vim 7.2
" Language:     Trajaja
" Maintainer:   Jose M. Chumo Mata <jmchuma@gmail.com>
...
" keyword definitions
syn keyword javaExternal	package
syn match javaExternal		"\<import\>\(\s\+static\>\)\?"
syn keyword javaError		goto const
syn keyword javaConditional	if else
syn keyword javaRepeat		while for
syn keyword javaBoolean		true false
syn keyword javaConstant	null
syn keyword javaTypedef		this super
syn keyword javaOperator	new
syn keyword javaType		boolean char int double
syn keyword javaType		void
syn keyword javaStatement	return
syn keyword javaStorageClass	static
...
if exists("trajaja_highlight_trajaja_lang_ids")
  let trajaja_highlight_all=1
endif
if exists("trajaja_highlight_all")  || exists("trajaja_highlight_trajaja")  || exists("trajaja_highlight_trajaja_lang")
  " java.lang.*
...
if exists("trajaja_space_errors")
  if !exists("trajaja_no_trail_space_error")
    syn match   javaSpaceError  "\s\+$"
  endif
  if !exists("trajaja_no_tab_space_error")
...
if exists("trajaja_comment_strings")
...
if !exists("trajaja_ignore_javadoc") && main_syntax != 'jsp'
  syntax case ignore
  " syntax coloring for javadoc comments (HTML)
  syntax include @javaHtml <sfile>:p:h/../../../../usr/share/vim/vim72/syntax/html.vim
...
if exists("trajaja_highlight_functions")
  if trajaja_highlight_functions == "indent"
...
if exists("trajaja_highlight_debug")
...
if exists("trajaja_mark_braces_in_parens_as_errors")
...
if !exists("trajaja_minlines")
  let trajaja_minlines = 10
endif
exec "syn sync ccomment javaComment minlines=" . trajaja_minlines

" The default highlighting.
if version >= 508 || !exists("did_trajaja_syn_inits")
  if version < 508
    let did_trajaja_syn_inits = 1
  endif
